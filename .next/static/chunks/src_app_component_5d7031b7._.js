...
"[project]/src/app/component/LogoIntro.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LogoIntro() {
    ...
    const [particlePositions, setParticlePositions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LogoIntro.useEffect": ()=>{
            ...
            const sequence = [
                {
                    "LogoIntro.useEffect": ()=>setAnimationStep(1)
                }["LogoIntro.useEffect"],
                {
                    "LogoIntro.useEffect": ()=>setAnimationStep(2)
                }["LogoIntro.useEffect"],
                {
                    "LogoIntro.useEffect": ()=>{
                        setAnimationStep(3);
                        let i = 0;
                        const typeWriter = {
                            "LogoIntro.useEffect.typeWriter": ()=>{
                                if (i < fullText.length) {
                                    ...
                                    timeoutRef.current = setTimeout({
                                        "LogoIntro.useEffect.typeWriter": ()=>{
                                            setAnimationStep(4);
                                            timeoutRef.current = setTimeout({
                                                "LogoIntro.useEffect.typeWriter": ()=>setShow(false)
                                            }["LogoIntro.useEffect.typeWriter"], 1000);
                                        }
                                    }["LogoIntro.useEffect.typeWriter"], 1000);
                                }
                            }
...
_s(LogoIntro, "je3glBJp40zXEJiLzrr1fdn98tQ=");
_c = LogoIntro;
var _c;
...
//# sourceMappingURL=src_app_component_5d7031b7._.js.map