...
/**
 * Hero Component - Version "Afro-Tech Structured"
 * Concept : Une grille architecturale, des couleurs identitaires subtiles et une mise en page asymétrique.
 */
...
const Hero = () => {
  return (
    <section className="relative min-h-screen w-full flex flex-col justify-center items-center overflow-hidden px-6"
      ...
      {/* Lueurs d'ambiance (Tes couleurs) */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="text-left space-y-8">
          ...
          <p className="text-lg text-gray-400 max-w-lg leading-relaxed border-l-2 pl-6 animate-fade-in-up delay-100"
            ...
            Je construis des ponts numériques entre <span className="text-white font-medium">culture</span> et <span className="text-white font-medium">technologie</span>. 
            Développeur Front-End spécialisé en interfaces réactives et immersives.
          </p>
          ...
          <div className="flex flex-wrap gap-4 animate-fade-in-up delay-200">
            <Link href="#projets" 
              ...
              Explorer mes projets <i className="pi pi-arrow-right"></i>
            </Link>
        ...
        {/* COLONNE DROITE : VISUEL TECHNIQUE */}
        <div className="relative flex justify-center items-center lg:justify-end animate-fade-in delay-300">
          ...
          <div className="relative w-80 h-96 md:w-[28rem] md:h-[34rem]">
            ...
            {/* Éléments décoratifs derrière */}
            <div className="absolute top-[-20px] right-[-20px] w-24 h-24 border-t-4 border-r-4 transition-all duration-500 group-hover:translate-x-2"
                 style={{ borderColor: colors.gold }} />
            <div className="absolute bottom-[-20px] left-[-20px] w-24 h-24 border-b-4 border-l-4 transition-all duration-500 group-hover:-translate-x-2"
                 style={{ borderColor: colors.red }} />
            
            {/* Container Image */}
            <div className="relative w-full h-full bg-gray-900 overflow-hidden shadow-2xl group">
              {/* Remplace '/images/portrait.jpg' par ta vraie photo */}
              <Image 
                src="/mascote.png"  
                alt="Portrait KingTang"
                fill
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-3 animate-fade-in delay-300">
        <span className="text-[10px] font-mono uppercase tracking-[0.2em] opacity-50">Scroll</span>
        <div className="w-[1px] h-12 bg-gradient-to-b from-transparent via-white to-transparent opacity-30" />
      </div>

      {/* --- CSS IN JS (Styles Locaux) --- */}
      <style jsx>{`
